...
@section('content')
{{ Form::open(['route' => ['news.update',$resource->id],'method' => 'PATCH','files'=>'true','enctype'=>'multipart/form-data', 'id' => 'form']) }}
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('title',$resource->title,['id'=>'title','class' => 'form-control']) }}
